...
<body class="min-h-screen flex flex-col">
  ...
  <div id="privacy-modal" class="fixed inset-0 z-[1000] flex items-center justify-center p-4 sm:p-6 bg-black/85 backdrop-blur-md opacity-0 pointer-events-none transition-all duration-300">
    <div class="relative w-full max-w-2xl bg-[#0c1020] border border-white/10 rounded-2xl shadow-2xl p-5 sm:p-7 flex flex-col max-h-[90vh] sm:max-h-[85vh]">
