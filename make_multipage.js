    ...
    <div class="relative w-full max-w-2xl bg-[#0c1020] border border-white/10 rounded-2xl shadow-2xl p-5 sm:p-7 flex flex-col max-h-[calc(100vh-120px)]">
      ...
      <div class="overflow-y-auto pr-2 text-xs sm:text-sm text-gray-300 leading-relaxed space-y-4 custom-scrollbar flex-1">
        ...
        <div class="p-3.5 rounded-xl bg-white/[0.03] border border-white/5 space-y-1 text-xs">
          ...
          <div class="text-gray-400">Контактный Email: <a href="mailto:avtosputnickv@ya.ru" class="text-red-400 hover:underline">avtosputnickv@ya.ru</a></div>
        </div>
        ...
        <p>Пользователь вправе отозвать свое согласие на обработку персональных данных в любой момент, направлением письменного уведомления на e-mail: <a href="mailto:avtosputnickv@ya.ru" class="text-red-400 hover:underline">avtosputnickv@ya.ru</a>.</p>
      </div>
  ...
  <section class="py-12 max-w-4xl mx-auto">
    ...
    <div class="bg-white/[0.03] border border-white/10 rounded-2xl p-6 sm:p-8 text-gray-300 space-y-4 leading-relaxed">
      ...
      <div class="p-4 rounded-xl bg-white/[0.03] border border-white/5 space-y-1.5 text-sm my-4">
        ...
        <div>Email: <a href="mailto:avtosputnickv@ya.ru" class="text-red-400 hover:underline">avtosputnickv@ya.ru</a></div>
      </div>
      ...
      <p>ООО «Автоспутник»<br>ИНН: 3443140210 / ОГРН: 1183443013115<br>Адрес офиса: г. Лида<br>Email: avtosputnickv@ya.ru</p>
    </div>
  </section>
`;
